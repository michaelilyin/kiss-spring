...
dependencies {
  ...
  api("org.springframework.data:spring-data-r2dbc:1.1.0.RELEASE")
//  compile("org.springframework.boot.experimental:spring-boot-autoconfigure-r2dbc:0.1.0.M3")
//  api("org.springframework.boot:spring-boot-starter-data-jdbc")

  api("org.jetbrains.kotlinx:kotlinx-coroutines-slf4j:1.3.5")
  api("org.jetbrains.kotlinx:kotlinx-coroutines-reactor:1.3.5")
